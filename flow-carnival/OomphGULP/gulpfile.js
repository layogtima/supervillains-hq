...
// clean img folder - remove compressed files only
function cleanimg() {
  return del(['app/img/**/*', '!app/img/src', '!app/img/src/*', '!app/img/svg', '!app/img/svg/*'])
}
...
// build function
exports.build         = series(cleandist, styles, cssmin, cssexp, html, libs, libsexp, images, buildcopy, buildalljs);
